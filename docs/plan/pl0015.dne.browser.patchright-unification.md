...
3. **[P1] PinchTab 不只在 runner 里**：启动链（commands.ts）、提示词注入（tool-loop.ts）、agent prompt、[tk0013.dne.browser.pinchtab-single-browser-substrate-bootstrap.md](/Users/admin/GitProjects/msgcode/issues/tk0013.dne.browser.pinchtab-single-browser-substrate-bootstrap.md) 都写死了 PinchTab。
...
| `issues/tk0013.dne.browser.pinchtab-single-browser-substrate-bootstrap.md` | 冻结的 PinchTab 路径契约 | 更新契约 |
...
| `docs/plan/rs0013.dne.browser.pinchtab-validation.md` | 历史记录 | 不改，保留历史 |
