...
参考文档 [CLI is All Agents Need](/Users/admin/GitProjects/msgcode/docs/plan/pl260312-cli-is-all-agents-need-reference.md) 给出的启发是对的：CLI 合同应该成为 Agent 的正式骨架。但 msgcode 当前不是输在“功能少”，而是输在“骨架还没完全收正”。
