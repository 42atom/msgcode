...
1. 归档剩余 IndexTTS 残留
   ...
   - 修正 `docs/plan/pl260311-backend-command-lanes-v1.md`
2. 收口 `0079 local-backend / OMLX`
   ...
   - `docs/plan/pl260311-local-backend-control-plane-mvp.md`
3. 收口研究文档与 artifacts
   - `AIDOCS/notes/mobile-relay-260311/*`
   - `docs/plan/rs0066.doi.agent.future-architecture-node.md`
   - `docs/plan/rs260310-mobile-entry-options.md`
...
3. `docs/plan/pl260311-backend-command-lanes-v1.md` 已改成 Qwen-only 的当前口径
