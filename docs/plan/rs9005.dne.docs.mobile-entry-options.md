...
- `msgcode` 当前正式方向：
  ...
  - [docs/plan/pl0065.tdo.feishu.p2.post-imessage-channel-strategy.md](/Users/admin/GitProjects/msgcode/docs/plan/pl0065.tdo.feishu.p2.post-imessage-channel-strategy.md)
- 当前通道代码现状：
