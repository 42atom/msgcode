...
TMP_MANIFEST="$INSTALL_ROOT/appliance.manifest.next"
...
MSGCODE_APPLIANCE_MANIFEST_VERSION=$MANIFEST_VERSION
MSGCODE_APPLIANCE_APP_VERSION=$APP_VERSION
MSGCODE_APPLIANCE_RUNTIME_DIR=$RUNTIME_DIR
MSGCODE_APPLIANCE_LAUNCHER_REL=$LAUNCHER_REL
MSGCODE_APPLIANCE_RUNTIME_BIN_REL=$RUNTIME_BIN_REL
MSGCODE_APPLIANCE_NODE_BIN_REL=$NODE_BIN_REL
EOF

if [ -f "$INSTALLED_MANIFEST" ]; then
  rm -f "$PREV_MANIFEST"
  mv "$INSTALLED_MANIFEST" "$PREV_MANIFEST"
fi
mv "$TMP_MANIFEST" "$INSTALLED_MANIFEST"
