...
plan_doc: docs/plan/pl0013.dne.browser.pinchtab-single-browser-substrate-bootstrap.md
links:
  - issues/tk0004.cand.browser.p0.web-transaction-platform-core.md
  - issues/tk0005.dne.browser.browser-tool-not-exposed-to-llm.md
created: 2026-03-07
due:
---

> 状态：已被 `issues/tk0016.dne.browser.patchright-browser-cutover.md` 取代。
...
- [x] 创建并评审 Plan 文档：`docs/plan/pl0013.dne.browser.pinchtab-single-browser-substrate-bootstrap.md`
...
- 2026-03-07：已被 `issues/tk0016.dne.browser.patchright-browser-cutover.md` 取代。PinchTab 不再是正式浏览器底座，本单保留为历史决策与回滚参照。
...
- Docs：`docs/plan/pl0013.dne.browser.pinchtab-single-browser-substrate-bootstrap.md`
- 冻结口径（2026-03-07）：
  - PinchTab 是唯一正式浏览器底座
...
- Plan: `docs/plan/pl0013.dne.browser.pinchtab-single-browser-substrate-bootstrap.md`
- Related: `issues/tk0004.cand.browser.p0.web-transaction-platform-core.md`
- Related: `issues/tk0005.dne.browser.browser-tool-not-exposed-to-llm.md`
