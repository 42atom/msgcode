...
- [x] 创建并评审 Plan 文档：`docs/plan/plan-260307-pinchtab-single-browser-substrate-bootstrap.md`
...
- Plan: `docs/plan/plan-260307-pinchtab-single-browser-substrate-bootstrap.md`
