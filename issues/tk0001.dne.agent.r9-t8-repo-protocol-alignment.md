...
plan_doc: docs/plan/pl0001.dne.agent.r9-t8-repo-protocol-alignment.md
links:
  - docs/archive/tasks/p5-7-r9-t8-repo-protocol-alignment.md
---

## Context

当前仓库主文档集中在 `docs/tasks`，但 `CLAUDE.md` 要求的协议目录（`issues/`、`docs/plan/`、`docs/notes/`、`docs/adr/`、`docs/CHANGELOG.md`）尚未落地，导致“规范存在但无法执行校验”。
...
- Task: `docs/archive/tasks/p5-7-r9-t8-repo-protocol-alignment.md`
