...
- [x] 创建并评审 Phase B Plan：`docs/plan/plan-260307-patchright-browser-cutover.md`
...
- 历史档案 / 回滚锚点：
  ...
  - `issues/0013-pinchtab-single-browser-substrate-bootstrap.md`
  - `docs/plan/plan-260307-pinchtab-single-browser-substrate-bootstrap.md`
  - `docs/plan/plan-260307-runtime-skill-source-sync.md`
- TypeScript：
...
- Plan: `docs/plan/plan-260307-patchright-browser-cutover.md`
