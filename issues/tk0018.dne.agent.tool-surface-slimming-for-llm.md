...
plan_doc: docs/plan/pl0018.dne.agent.tool-surface-slimming-for-llm.md
links:
...
- [x] 创建并评审 Plan 文档：`docs/plan/pl0018.dne.agent.tool-surface-slimming-for-llm.md`
...
- Plan: `docs/plan/pl0018.dne.agent.tool-surface-slimming-for-llm.md`
