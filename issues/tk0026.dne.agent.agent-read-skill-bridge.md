...
plan_doc: docs/plan/pl0026.dne.agent.agent-read-skill-bridge.md
links:
  - docs/archive/tasks/p5-7-r15-agent-read-skill-bridge.md
  - /Users/admin/GitProjects/msgcode/docs/plan/pl0022.dne.tools.scheduler-skill-bash-mainline.md
  - /Users/admin/GitProjects/msgcode/docs/plan/pl0024.dne.tools.skill-single-source-runtime.md
  - /Users/admin/GitProjects/msgcode/issues/tk0027.pss.agent.p0.llm-skill-directory-open-loop.md
created: 2026-03-08
due:
---
...
- Task: `docs/archive/tasks/p5-7-r15-agent-read-skill-bridge.md`
