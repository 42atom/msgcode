...
plan_doc: docs/plan/pl0066.pss.agent.agent-core-gap-vs-openclaw.md
links: []
---
...
- 当前已有相关方向文档：
  - `docs/plan/pl0058.dne.agent.long-running-agent-context-smoothing.md`
...
- Research: `docs/plan/rs0088.dne.agent.openclaw-agent-core-gap.md`
- Research: `docs/plan/rs9007.dne.agent.openclaw-terminal-agent-harness.md`
- Plan: `docs/plan/pl0066.pss.agent.agent-core-gap-vs-openclaw.md`
- Task: `docs/archive/tasks/p6-agent-core-run-core-dispatch-pack.md`
