...
plan_doc: docs/plan/pl0066.doi.agent.agent-core-gap-vs-openclaw.md
links: []
---
...
- 当前已有相关方向文档：
  - `docs/plan/plan-260310-long-running-agent-context-smoothing.md`
  - `docs/plan/plan-260310-post-imessage-channel-strategy.md`
  - `docs/plan/rs0066.doi.agent.future-architecture-node.md`
...
- Research: `docs/plan/rs0088.doi.agent.openclaw-agent-core-gap.md`
- Research: `docs/plan/rs9007.dne.agent.openclaw-terminal-agent-harness.md`
- Plan: `docs/plan/plan-260310-agent-core-gap-vs-openclaw.md`
