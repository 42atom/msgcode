...
plan_doc: docs/plan/pl0071.pss.docs.skill-layering-and-conflict-policy.md
links: []
---
...
- 研究文档已经落地：
  - [rs0071.dne.docs.skill-layering-and-conflict-policy.md](/Users/admin/GitProjects/msgcode/docs/plan/rs0071.dne.docs.skill-layering-and-conflict-policy.md)
- 设计文档已经落地：
  - [pl0071.pss.docs.skill-layering-and-conflict-policy.md](/Users/admin/GitProjects/msgcode/docs/plan/pl0071.pss.docs.skill-layering-and-conflict-policy.md)
- 当前 skill README 也已经吸收了主结论：
  - [src/skills/README.md](/Users/admin/GitProjects/msgcode/src/skills/README.md)
  - 已明确 `runtime / optional`
  - 已显式承认 `legacy-active`
  - 已把 `<workspace>/.msgcode/skills/` 标成待实现层
- 这张单的交付本质上是“冻结最小分层模型与冲突策略”，不是立刻改 runtime 实现；现状已满足这条验收口径

## Verification

- `sed -n '1,240p' src/skills/README.md`
- `sed -n '1,260p' docs/plan/rs0071.dne.docs.skill-layering-and-conflict-policy.md`
- `sed -n '1,260p' docs/plan/pl0071.pss.docs.skill-layering-and-conflict-policy.md`

结果：

- 已明确最小分层：`runtime / optional / legacy-active / workspace`
- 已明确冲突策略与 core 保留区口径
- 已形成可继续实施的 research + plan，而不是只停在聊天结论

## Links

- Plan: /Users/admin/GitProjects/msgcode/docs/plan/pl0071.pss.docs.skill-layering-and-conflict-policy.md
- Research: /Users/admin/GitProjects/msgcode/docs/plan/rs0071.dne.docs.skill-layering-and-conflict-policy.md
