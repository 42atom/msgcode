...
- 参考文档迁入路径：
  - `docs/plan/plan-260312-cli-is-all-agents-need-reference.md`
- 重点审计文件：
...
- 已落地到：
  ...
  - `docs/plan/plan-260312-read-file-contract-and-preview-layering.md`
  - `issues/0121-help-tool-and-quota-hot-path-thinning.md`
  - `docs/plan/plan-260312-help-tool-and-quota-hot-path-thinning.md`
  - `issues/0122-first-class-file-tools-and-write-preview-layering.md`
  - `docs/plan/plan-260312-first-class-file-tools-and-write-preview-layering.md`
  - `issues/0123-tool-preview-single-source-thinning.md`
  - `docs/plan/plan-260312-tool-preview-single-source-thinning.md`
  - `issues/0124-native-tool-first-prompt-and-skill-contract.md`
  - `docs/plan/plan-260312-native-tool-first-prompt-and-skill-contract.md`

## Links

- [参考文档](/Users/admin/GitProjects/msgcode/docs/plan/plan-260312-cli-is-all-agents-need-reference.md)
- [正式 Plan](/Users/admin/GitProjects/msgcode/docs/plan/plan-260312-cli-reference-vs-runtime-gap-review.md)
- [研究记录](docs/plan/rs9010.dne.tools.cli-reference-vs-msgcode.md)
