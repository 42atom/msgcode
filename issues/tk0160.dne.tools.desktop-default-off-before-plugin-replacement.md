...
plan_doc: docs/plan/pl0160.dne.tools.desktop-default-off-before-plugin-replacement.md
links: []
---
...
- `docs/plan/pl0163.dne.ghost.ghost-os-desktop-plugin-replacement.md` 已要求冻结自研 desktop 扩张
