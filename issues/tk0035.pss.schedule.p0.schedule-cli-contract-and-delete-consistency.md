...
plan_doc: docs/plan/pl0035.pss.schedule.schedule-cli-contract-and-delete-consistency.md
links: []
---
...
- [x] 真机 smoke：创建 tk0035-test -> 删除 -> 验证一致性
- [ ] 提交 commit
...
- issues/tk0034.pss.schedule.p0.schedule-stop-workspace-and-projection-sync.md
