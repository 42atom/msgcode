...
- issues/0021-prompt-message-stratification-experiment.md -> issues/tk0021.tdo.agent.prompt-message-stratification-experiment.md
- issues/0027-llm-skill-directory-open-loop.md -> issues/tk0027.doi.agent.llm-skill-directory-open-loop.md
- issues/0034-schedule-stop-workspace-and-projection-sync.md -> issues/tk0034.tdo.schedule.schedule-stop-workspace-and-projection-sync.md
- issues/0035-schedule-cli-contract-and-delete-consistency.md -> issues/tk0035.tdo.schedule.schedule-cli-contract-and-delete-consistency.md
...
- issues/0067-ghost-os-desktop-plugin-replacement.md -> issues/tk0067.tdo.ghost.ghost-os-desktop-plugin-replacement.md
...
- issues/0094-heavy-resource-admission-mvp.md -> issues/tk0094.tdo.ghost.heavy-resource-admission-mvp.md
