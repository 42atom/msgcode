...
export const DEFAULT_WORKSPACE_CONFIG: Required<WorkspaceConfig> = {
  ...
  "tooling.allow": ["tts", "asr", "vision", "bash", "browser", "desktop", "read_file", "help_docs", "feishu_list_members", "feishu_list_recent_messages", "feishu_reply_message", "feishu_react_message", "feishu_send_file"], // 默认文件主链收口为 read_file + bash，CLI 合同探索走 help_docs
