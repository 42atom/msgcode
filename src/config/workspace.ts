...
export const DEFAULT_WORKSPACE_CONFIG: Required<WorkspaceConfig> = {
  ...
  "tooling.allow": ["tts", "asr", "bash", "browser", "desktop", "read_file", "write_file", "edit_file", "help_docs", "feishu_list_members", "feishu_list_recent_messages", "feishu_reply_message", "feishu_react_message", "feishu_send_file"], // 默认文件主链恢复为 read/write/edit + bash，CLI 合同探索走 help_docs；vision 改为显式 opt-in
